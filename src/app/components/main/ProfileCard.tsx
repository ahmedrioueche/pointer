...
const ProfileCard: React.FC<ProfileCardProps> = ({ name, age, gender, current_points, level, icon, onEditProfile, onAssignTasks }) => {
      ...
      <div className="text-center">
        ...
        {current_points && (
          <p className="text-lg md:text-xl font-light">
            <FaStar className="inline-block mr-1 mb-1" /> {current_points}
          </p>
        )}
        </div>
