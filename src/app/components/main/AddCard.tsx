  ...
  return (
    ...
    >
      <div className="flex flex-col items-center space-y-4">
        <div className="relative w-25 h-25 bg-gradient-to-r from-purple-500 via-blue-600 to-teal-700 dark:from-purple-800 dark:via-blue-900 dark:to-teal-800 rounded-full flex items-center justify-center shadow-xl">
          <img src="/icons/girl_7.png" alt="Child" className="w-22 h-22 rounded-full" /> {/* Image in the center */}
        </div>
