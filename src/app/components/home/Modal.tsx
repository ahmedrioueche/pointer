  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 max-w-md w-full h-[90vh] overflow-hidden rounded-lg shadow-lg relative">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors text-3xl p-2 rounded-full"
        >
          &times;
        </button>
