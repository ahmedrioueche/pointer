...
const ProfileModal: React.FC<ProfileModalProps> = ({ child, isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-[90vw] max-h-[97vh] overflow-y-auto task-menu">
        ...
        <div className="flex justify-center mt-6">
          <button
            type="submit"
            className="flex flex-row items-center justify-center w-60 bg-light-primary text-white px-4 py-3 rounded-md hover:bg-accent hover:text-light-text dark:hover:text-light-text font-satisfy transition duration-300 dark:hover:bg-dark-accent hover:bg-light-accent"
