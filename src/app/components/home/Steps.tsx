...
const StepCard: React.FC<StepProps> = ({ icon, title, description }) => (
  <div className="flex flex-col items-start p-6 bg-dark-background dark:bg-light-background rounded-lg shadow-md mb-8 transition-transform transform hover:scale-105 hover:shadow-lg">
    ...
    <section className={`py-16 bg-light-background dark:bg-dark-background`}>
      <div className="container mx-auto px-4 flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 max-w-md">
          <h2 className="text-3xl font-bold  font-satisfy mb-4 text-light-primary dark:text-dark-text">How It Works</h2>
        ...
        <div className="w-full md:w-1/2 ml-0 md:ml-11 mt-8 md:mt-0">
