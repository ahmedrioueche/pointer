...
const DashboardNavbar = ({ firstName } : any) => {
  ...
  return (
    <nav className="relative z-1000 top-0 left-0 w-full py-4 px-6 shadow-md bg-light-background dark:bg-dark-background">
      ...
      {isMenuOpen && (
        <div className="md:hidden z-[100] overflow-y-scroll items-center fixed top-0 right-0 w-[18rem] h-screen bg-light-background dark:bg-dark-background flex flex-col p-4 space-y-4">
          <button
            onClick={toggleMenu}
