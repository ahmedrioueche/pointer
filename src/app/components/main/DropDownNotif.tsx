...
const DropdownNotifications: React.FC<{ onClick: () => void, isMenuOpen: boolean }> = ({ onClick, isMenuOpen }) => {
  ...
  return (
    <div className="relative">
      ...
      {isDropdownOpen && (
        <div className="absolute right-0 mt-2 w-65 bg-light-background dark:bg-dark-background border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg z-50">
          <div className="p-4">
